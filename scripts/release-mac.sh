...
REPO_NAME="LegendOfZeldaNESRecomp"      # GitHub repo / zip basename
APP_NAME="Legend of Zelda"        # .app display name (may contain spaces)
TARGET="LegendOfZeldaNESRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v1.4.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="The Legend of Zelda (USA) .nes dump"        # human description of the ROM the user must supply
# ==============================================
